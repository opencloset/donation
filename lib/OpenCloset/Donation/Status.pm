...
our @ALL = ( $NULL, $WAITING, $DELIVERING, $DELIVERED, $RETURNED, $CANCEL, $DO_NOT_RETURN, $REGISTERED );
our @ALL_LABEL = (
    $LABEL_NULL,     $LABEL_WAITING, $LABEL_DELIVERING,    $LABEL_DELIVERED,
    $LABEL_RETURNED, $LABEL_CANCEL,  $LABEL_DO_NOT_RETURN, $LABEL_REGISTERED
);
